...
export function RevisionModeBanner() {
  ...
  if (!isRevisionMode && timeRemaining.days <= 30 && !timeRemaining.isExamOver) {
    return (
      <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-4 py-2 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium">
            ...
            <span className="font-bold font-mono">{timeRemaining.days}d {timeRemaining.hours}h {timeRemaining.minutes}m</span>
